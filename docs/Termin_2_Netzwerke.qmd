...
- [ ] Die Netzwerkkonfiguration (z.B. WLAN-Zugangsdaten) wird über eine Konfig-Datei [`settings.toml`](src/raspi_firmware/settings.toml) bereitgestellt, die der Microcontroller beim Start einliest.
...
- [ ] Die Schnittstellen sind in der OpenAPI Specification dokumentiert siehe [`openapi.yaml`](docs/iot-specs/openapi.yaml) und [`conventions.md`](docs/iot-specs/conventions.md).
